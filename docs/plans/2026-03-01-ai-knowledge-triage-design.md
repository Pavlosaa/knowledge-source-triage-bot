...
[Notion Writer] — only if has_value = true
  - finds or creates "AI Sources" database under "ICT Project R&D Resources"
  - creates a record (page) in the database
  - title: generated by Claude from context
  - database properties: topic, source URL, discovery score, tags, date, author, content type
